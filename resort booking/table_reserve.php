  ...
  if($total!=0)
  {
    while($result=mysqli_fetch_assoc($data))
    {
     ?>
      ...
      <td><?php echo $result['SelectDay'];?></td>
      <td><?php echo $result['SelectHour'];?></td>
      <td><?php echo $result['FullName'];?></td>
      <td><?php echo $result['PhoneNumber'];?></td>
      <td><?php echo $result['HowManyPersons'];?></td>
      <td>
      <form action="del_table.php" method="post">
